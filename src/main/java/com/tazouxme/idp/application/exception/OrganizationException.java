...
public class OrganizationException extends AbstractIdentityProviderException {
	...
	public OrganizationException(IdentityProviderExceptionCode code, String message) {
		super(code, message);
	}
	
	public OrganizationException(IdentityProviderExceptionCode code, String message, Throwable e) {
