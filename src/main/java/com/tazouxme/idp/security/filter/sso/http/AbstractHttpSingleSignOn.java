...
public abstract class AbstractHttpSingleSignOn extends AbstractSingleSignOn {
	
	public AbstractHttpSingleSignOn(IdentityProviderConfiguration configuration) {
		super(configuration);
	}
	
	public AbstractHttpSingleSignOn(IdentityProviderConfiguration configuration, StageChain stages) {
