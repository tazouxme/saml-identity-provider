...
public abstract class AbstractSingleSignOn implements ISingleSignOn {
	...
	public AbstractSingleSignOn(IdentityProviderConfiguration configuration) {
		this.configuration = configuration;
	}

	public AbstractSingleSignOn(IdentityProviderConfiguration configuration, StageChain stages) {
		this.configuration = configuration;
		this.stages = stages;
	}
