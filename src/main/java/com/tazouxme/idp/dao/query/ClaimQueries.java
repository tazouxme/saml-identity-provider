...
public class ClaimQueries {
	...
	public static final String FIND_ALL = "select s from Claim s join fetch s.organization o "
			+ "where o.externalId = :" + PARAM_ORGANIZATION_ID;
	public static final String FIND_BY_ID = "select s from Claim s join fetch s.organization o "
			+ "where s.externalId = :" + PARAM_ID + " and o.externalId = :" + PARAM_ORGANIZATION_ID;
	public static final String FIND_BY_URI = "select s from Claim s join fetch s.organization o "
