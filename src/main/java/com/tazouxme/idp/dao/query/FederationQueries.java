...
public class FederationQueries {
	...
	public static final String FIND_BY_URN = "select s from Federation s "
	...
	public static final String FIND_BY_ORGANIZATION = "select s from Federation s "
			+ "join fetch s.organization o join fetch s.user join fetch s.application a "
			+ "where o.externalId = :" + PARAM_ORGANIZATION_ID;
	public static final String FIND_BY_USER = "select s from Federation s "
	...
	public static final String FIND_BY_USER_AND_URN = "select s from Federation s "
			+ "join fetch s.organization o join fetch s.user u join fetch s.application a "
